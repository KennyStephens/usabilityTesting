    ...
    <v-layout class="text-xs-center">
      ...
      <v-flex xs12>
        ...
        >Add custom tasks to have your Testers accomplish to get more data to help you better your sites navigation and usability. Press the (+) icon to add more than one task.
          <br>
          <strong class="red--text">A MAXIMUM OF 5 TASKS MAY BE USED</strong>
        </p>
        <hr class="mb-5">
        <v-form class="text-xs-left mb-5" name="noLog" action="/site/" method="post">
        <p class="grey--text darken-4 text-xs-center">Give your test a name for easier tracking.</p>
          <v-text-field 
            class="task-name"
            label="Test Name"
            name="testName" 
